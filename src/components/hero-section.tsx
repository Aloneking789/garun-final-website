...
export default function HeroSection() {
  return (
    <section id="home" className="pt-10 md:pt-16 pb-8 md:pb-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6 animate-slide-up">
            <h1 className="text-4xl font-extrabold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl font-headline animate-pulse-soft" style={{'animation': 'slide-up 0.8s cubic-bezier(0.34, 1.56, 0.64, 1), pulse-soft 2s cubic-bezier(0.4, 0, 0.6, 1) infinite'}}>
              Launch Your Mobile App in Weeks, Not Months
            </h1>
            <p className="max-w-[600px] text-muted-foreground md:text-xl hover-text-expand" style={{'animation': 'slide-up 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 0.1s both'}}>
